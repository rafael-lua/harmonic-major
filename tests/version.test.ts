...
describe("bumpPackages with yarn", () => {
    let tempRepoPath: string = ""

    beforeAll(async () => {
        tempRepoPath = await setupTempGitRepository((tempDir) =>
            defaultRepositoryCommands(tempDir, false),
        )
    })
...
describe("bumpPackages with pnpm", () => {
    let tempRepoPath: string = ""

    beforeAll(async () => {
        tempRepoPath = await setupTempGitRepository((tempDir) =>
            defaultRepositoryCommands(tempDir, true),
        )
    })
